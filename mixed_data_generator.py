...
def create_dataset(subspace_frac, dims, num_devices, num_data, frac_outlying_devices=1.0, frac_outlying_data=0.01):
...
if __name__ == '__main__':
    ...
    create_dataset(subspace_frac, dims, num_devices, num_data, frac_outlying_devices, frac_outlying_data)