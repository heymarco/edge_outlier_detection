...
if use_convolutional:
	models = create_deep_models(num_devices=num_devices, dims=(32, 32, 3), compression_factor=0.4)
else:
	models = create_models(num_devices=num_devices, dims=32*32*3, compression_factor=0.4)
